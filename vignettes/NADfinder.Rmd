...
abstract: >
  Nucleolus is an important structure inside the nucleus 
    in eukaryotic cells. It is the site for rRNA transcription 
    and ribosome biogenesis. In addition, nucleoli are dynamic hubs 
    ...
    Here, we developed a Bioconductor package NADfinder for bioinformatic 
...
path <- system.file("data", package = "NADfinder", lib.loc = NULL,
            mustWork = TRUE)
...
dat <- log2se(se, nucleoleusCols = "nucleoleus.bam", genomeCols="genome.bam", transformation = "log2Ratio")
